...
var corsOptions = {
  ...
  'http://localhost:8082', 'https://santiagomedioambiente.transformaciondigitalcusco.in', 'http://santiagomedioambiente.transformaciondigitalcusco.in', 'http://190.234.243.220:8080', 'http://localhost:8080', 'http://10.0.0.216:8080', 'http://10.0.0.216:3000/login', 'https://transformaciondigital.guamanpoma.org', 'https://santiagolimpio.guamanpoma.org', 'http://localhost:3000', 'http://10.0.0.193:8082', 'http://10.0.0.193/Sistema_MesaPartes_GPA/tramite_nuevo.php', 'https://especializacionseguridadalimentaria.guamanpoma.org'],
